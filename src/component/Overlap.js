...
function Overlap() {
    return ( 
        <section className="Overlap_Section">
            <div class="Overlap_Container">
                <div class="left"></div>
                    <div class="right">
                        <div class="Overlap_Content">
                            <h1>What is Sol Cosmos?</h1>
                            <p>7777 Algorithmically generated, hand-crafted pixelart planets with many differnt unique attributes.</p>
                            <p>Each planet is an exclusive NFT with proof of ownership stored on the Solana blockchain.</p>
                            <p> From out of this world and beyond! </p>
